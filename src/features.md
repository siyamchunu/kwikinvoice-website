...
<article itemscope itemtype="https://schema.org/WebPage">
  <h1 itemprop="name">KwikInvoice Features</h1>
  
  <p class="lead" itemprop="description">Everything you need to create professional invoices and manage your business on the go.</p>
  
  <section class="feature-detail">
    <h2>📄 Instant PDF Generation</h2>
    <p><strong>Speed:</strong> Generate professional PDF invoices in under 200ms - faster than any web-based solution.</p>
    <p><strong>Quality:</strong> Beautiful, professional invoice templates that represent your brand well.</p>
    <p><strong>Flexibility:</strong> Customize invoice fields, add your logo, and include payment terms.</p>
  </section>
