    ...
    <div class="container">
        <div class="hero-content">
            <div class="hero-text">
                ...
                <div class="hero-cta">
                    <a href="https://play.google.com/store/apps/details?id=com.kwikinvoice.app" class="btn-playstore" target="_blank" rel="noopener" onclick="fbq('track', 'Lead');">
                        <picture>
            ...
            <div class="hero-image">
                <div class="phone-mockup">
                    <picture>
                        <source 
                            srcset="/public/images/app-screenshot-invoice-400.webp 400w,
                                    /public/images/app-screenshot-invoice-800.webp 800w,
                                    /public/images/app-screenshot-invoice-1200.webp 1200w"
                            sizes="(max-width: 400px) 400px, (max-width: 800px) 800px, 304px"
                            type="image/webp">
        ...
        <script type="application/ld+json">
        {
          ...
          "step": [
            ...
            },
            {
              ...
              "text": "Add your client information or import contacts from your phone"
            },
            {
              "@type": "HowToStep",
              "name": "Create Invoice",
              "text": "Select the client, add invoice items, quantities, and prices"
            },
            {
              "@type": "HowToStep",
              "name": "Generate PDF",
    ...
    <div class="container">
        ...
        <div class="screenshots-row">
            <div class="screenshot-item">
                <picture>
                    <source 
                        srcset="/public/images/screenshot-dashboard-400.webp 400w,
                                /public/images/screenshot-dashboard-800.webp 800w"
                        sizes="(max-width: 400px) 400px, 200px"
                        type="image/webp">
            ...
            <div class="screenshot-item">
                <picture>
                    <source 
                        srcset="/public/images/screenshot-create-400.webp 400w,
                                /public/images/screenshot-create-800.webp 800w"
                        sizes="(max-width: 400px) 400px, 200px"
                        type="image/webp">
            ...
            <div class="screenshot-item">
                <picture>
                    <source 
                        srcset="/public/images/screenshot-pdf-400.webp 400w,
                                /public/images/screenshot-pdf-800.webp 800w"
                        sizes="(max-width: 400px) 400px, 200px"
                        type="image/webp">
    ...
    <div class="container">
        ...
        <div class="pricing-toggle-wrapper">
            ...
            <label class="pricing-toggle">
                <input type="checkbox" id="pricingToggle" aria-label="Switch between monthly and annual pricing">
                <span class="toggle-slider"></span>
            </label>
            <span class="toggle-label">Annual <span class="save-badge">Save 26%</span></span>
        </div>
        ...
        <div class="pricing-cards">
            ...
            <div class="pricing-card pricing-card-pro">
                ...
                <div class="card-header">
                    ...
                    <div class="price-container">
                        <span class="price price-monthly">R79</span>
                        <span class="price price-annual" style="display: none;">R699</span>
                ...
                <p class="card-note card-note-annual" style="display: none;">Save R250/year • Cancel anytime</p>
                <p class="card-note card-note-monthly">Cancel anytime</p>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="faq-grid">
            <div class="faq-item">
                ...
                <p>Yes! Upgrade to Pro instantly. Downgrade at the end of your billing period.</p>
            </div>
            <div class="faq-item">
                <h3>What happens when I hit the 5 invoice limit on Free?</h3>
                <p>You'll be prompted to upgrade to Pro. Existing invoices remain accessible.</p>
            </div>
            <div class="faq-item">
