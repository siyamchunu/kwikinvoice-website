...
image: /public/images/blog/sars-invoice-requirements-banner.jpg
imageAlt: "A calculator sitting on top of a wooden table — SARS invoice compliance"
imageCredit: 'Photo by <a href="https://unsplash.com/@workday" target="_blank" rel="noopener">Workday</a> on <a href="https://unsplash.com" target="_blank" rel="noopener">Unsplash</a>'
tags:
  - sars
  - invoicing
  - vat
...
Section 20 of the [Value-Added Tax Act](https://www.sars.gov.za/businesses-and-employers/government/tax-invoices/) sets out exactly what must appear on a tax invoice. Here are the **7 mandatory fields** that every full tax invoice must include:
...
**Good:** "Bathroom renovation — labour and materials, 14 Maple Street, Centurion"
**Not good enough:** "Services rendered"
...
These seven fields come directly from the [SARS Tax Invoice Checklist](https://www.sars.gov.za/wp-content/uploads/Docs/Government/Tax-Invoice-Checklist-Version-2-29032016.pdf). Bookmark that PDF — it's the official reference.
...
Under [Section 23 of the VAT Act](https://www.sars.gov.za/businesses-and-employers/government/tax-invoices/), you **must** register for VAT if your total taxable supplies (basically your revenue from taxable goods and services) exceed **R1 million in any 12-month period**.
...
*This guide is for informational purposes and does not constitute legal or tax advice. For advice specific to your situation, consult a registered tax practitioner. SARS requirements may change — always check the [official SARS website](https://www.sars.gov.za/businesses-and-employers/government/tax-invoices/) for the latest information.*
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if my invoice doesn't meet SARS requirements?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If your tax invoice is missing mandatory fields, your client may not be able to claim the VAT as an input deduction. SARS can also disallow the deduction during an audit and may impose penalties under Section 58 of the VAT Act."
      }
    },
    {
      "@type": "Question",
      "name": "Can I use a handwritten invoice?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Technically, yes — as long as it contains all the required information. But handwritten invoices are easy to lose, hard to duplicate, and look unprofessional. A digital invoice is faster, cleaner, and automatically stored."
      }
    },
    {
      "@type": "Question",
      "name": "Do I need to show VAT as a separate line item?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "On a full tax invoice (over R5,000), yes — you must show the VAT amount separately. On an abridged tax invoice (R5,000 or less), you can show the total as inclusive of VAT without a separate line."
      }
    },
    {
      "@type": "Question",
      "name": "What if my client asks for a tax invoice but I'm not VAT registered?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You cannot issue a tax invoice if you are not VAT registered. Explain to your client that you're not a VAT vendor, and issue a regular invoice instead."
      }
    },
    {
      "@type": "Question",
      "name": "Is a quote the same as an invoice?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. A quote is an estimate you give before doing the work. An invoice is a request for payment after the work is done. Quotes do not replace invoices for SARS purposes."
      }
    },
    {
      "@type": "Question",
      "name": "Can I email or WhatsApp my invoices?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Absolutely. SARS doesn't require paper invoices. You can send a PDF invoice via email, WhatsApp, or any other method. What matters is the content of the invoice, not how it's delivered."
      }
    },
    {
      "@type": "Question",
      "name": "What is the penalty for not issuing tax invoices?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Under Section 58 of the VAT Act, failure to issue a tax invoice can result in a fine. SARS can also disallow input tax deductions claimed by your clients and in serious cases can deregister you as a VAT vendor."
      }
    }
  ]
}
